  ...
  <el-card shadow="hover">
    <div class="videoPlayer" contenteditable="true" @keydown="videoPlayerKeyEvent" onselectstart="return false;">
      ...
      <div class="video_btn">
        ...
        <i class="playerBtn el-icon-arrow-right" title="下一帧(方向右)" type="step-forward"
        ...
        <i class="playerBtn el-icon-caret-bottom" title="跳转至入点" type="vertical-align-bottom"
...
<style scoped lang="less">
  .videoPlayer {
    ...
    .video_btn {
      ...
      .time-box { //给原有的span秒数标签嵌套进一个内敛块样式（可调节宽高的内联样式），解决原有后面的元素快会根据秒数宽度改变的小bug
        height: auto;
        width: 8rem;
